...
export const translator_zh_Hans = makeTranslator<TranslationArgs>({
	...
	"contextmenu.item.name.viewport.add": "添加",
	"contextmenu.item.name.viewport.add.object": "物件",

	"contextmenu.item.name.viewport.add.object.basic": "简单",
	...
	"contextmenu.item.name.viewport.add.object.circular": "圆形",
	...
	"contextmenu.item.name.viewport.add.object.moving": "移动",
